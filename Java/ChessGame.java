...
public class ChessGame extends JFrame implements MouseListener, MouseMotionListener 
{
 ...
 layeredPane = new JLayeredPane();
  ...
  JLabel piece = new JLabel( new ImageIcon("hors.png") );
  JPanel panel = (JPanel)chessBoard.getComponent(1);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("hors.png"));
  panel = (JPanel)chessBoard.getComponent(6);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("king.png"));
  panel = (JPanel)chessBoard.getComponent(4);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("oficeri.png"));
  panel = (JPanel)chessBoard.getComponent(2);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("oficeri.png"));
  panel = (JPanel)chessBoard.getComponent(5);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("torra.png"));
  panel = (JPanel)chessBoard.getComponent(7);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("torra.png"));
  panel = (JPanel)chessBoard.getComponent(0);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("mbreteresha.png"));
  panel = (JPanel)chessBoard.getComponent(3);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("ushtari.png"));
